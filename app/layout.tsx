...
export const metadata: Metadata = {
  ...
  description:
    "Professional video editing for small businesses across Auckland, Wellington, Christchurch, and throughout New Zealand. Scroll-stopping promo videos delivered in 24 hours from $60 NZD. Perfect for social media, restaurants, retail & services.",
  keywords: [
    "video marketing",
    ...
    "Christchurch promo videos",
    "New Zealand business videos",
    "video marketing New Zealand",
  ],
