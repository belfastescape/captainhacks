...
export const metadata: Metadata = {
  ...
  description:
    "Get scroll-stopping promo videos for your business in 24 hours. Professional video editing from $39. Perfect for restaurants, retail, services & more. Fast, affordable, unforgettable.",
  keywords: [
    "video marketing",
    "promo videos",
    "social media videos",
