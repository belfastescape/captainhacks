...
export default function BrandedOrderClient() {
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-black border-2 border-gray-700 p-8 mb-12">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="flex items-center justify-between bg-green-900/30 border border-green-400 p-3">
                    <div>
                      ...
                      <span className="text-gray-400 text-xs ml-2">
                        (Saved ${(39 - appliedDiscount.newPrice).toFixed(2)} USD)
                      </span>
                    </div>
                    <button
                      type="button"
              ...
              >
                {isSubmitting ? 'PROCESSING...' : `SUBMIT & PAY NOW → $${appliedDiscount ? `${appliedDiscount.newPrice.toFixed(2)} USD` : '39 USD'}`}
              </button>
