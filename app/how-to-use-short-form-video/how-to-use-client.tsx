        ...
        <section className="px-6 md:px-[8%] py-24 bg-black border-t border-gray-800">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-400 mb-12">
              Get started with scroll-stopping short-form video from <span className="text-cyan-400 font-bold">$60 NZD</span>.
            </p>
            ...
            <div className="grid grid-cols-3 gap-6 pt-12 border-t border-gray-800">
              ...
              <div>
                <div className="text-3xl font-bold text-pink-500 mb-2 font-mono">$60 NZD</div>
